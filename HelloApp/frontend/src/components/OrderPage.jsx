    ...
    <main className="form-page-wrapper">
      <div className="form-page-container">
        ...
        <form id="orderForm" onSubmit={handleSubmit}>
          ...
          <input className="form-page-input" type="text" id="name" name="name"
            value={formData.name} onChange={handleChange} placeholder="Иван" required />

          <label className="form-page-label" htmlFor="device">Устройство</label>
          <select className="form-page-select" id="device" name="device"
            value={formData.device} onChange={handleChange} required>
          ...
          <textarea className="form-page-select" id="model-device" name="model"
            value={formData.model} onChange={handleChange}
            placeholder="Например: iPhone 14 Pro" rows="1"></textarea>

          <label className="form-page-label" htmlFor="phone">Телефон</label>
          <input className="form-page-input" type="tel" id="phone" name="phone"
            value={formData.phone} onChange={handleChange}
            placeholder="+7 (___) ___-__-__" required />

          <label className="form-page-label" htmlFor="problem">Описание проблемы</label>
          <textarea className="form-page-textarea" id="problem" name="problem"
            value={formData.problem} onChange={handleChange}
            placeholder="Что случилось?" rows="4" required></textarea>

          <label className="form-page-label" htmlFor="email">Email (необязательно)</label>
          <input className="form-page-input" type="email" id="email" name="email"
